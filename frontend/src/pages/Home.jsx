...
const SLIDES = [
  {
    ...
    bgDark: 'from-slate-900 via-blue-950/40 to-slate-950',
    bgLight: 'from-blue-50 via-sky-100/60 to-indigo-50',
  ...
  },
  {
    ...
    title: <>Haier 258L <span className="text-emerald-500 font-bold">Convertible 3 Star</span></>,
    ...
    bgDark: 'from-slate-900 via-emerald-950/30 to-slate-950',
    bgLight: 'from-emerald-50 via-teal-100/60 to-slate-50',
  ...
  },
  {
    ...
    title: <>boAt Cosmos Pro <span className="text-indigo-500">Fitness Tracker</span></>,
    ...
    bgDark: 'from-slate-900 via-indigo-950/40 to-slate-950',
    bgLight: 'from-indigo-50 via-purple-100/60 to-slate-50',
  ...
  },
  {
    ...
    title: <>acer I Series <span className="text-purple-500">50-Inch 4K Ultra HD</span></>,
    ...
    bgDark: 'from-slate-900 via-purple-950/40 to-slate-950',
    bgLight: 'from-purple-50 via-fuchsia-100/60 to-slate-50',
  ...
  },
  {
    ...
    title: <>boAt Airdopes 111 <span className="text-orange-500 font-bold">TWS Earbuds</span></>,
    ...
    bgDark: 'from-slate-900 via-orange-950/30 to-slate-950',
    bgLight: 'from-orange-50 via-amber-100/60 to-slate-50',
  ...
  },
  {
    ...
    title: <>boAt BLITZ 2000 <span className="text-teal-500">Multimedia Speaker</span></>,
    ...
    bgDark: 'from-slate-900 via-teal-950/30 to-slate-950',
    bgLight: 'from-teal-50 via-cyan-100/60 to-slate-50',
  ...
  },
  {
    ...
    bgDark: 'from-slate-900 via-amber-950/30 to-slate-950',
    bgLight: 'from-amber-50 via-yellow-100/60 to-slate-50',
  ...
  },
  {
    ...
    title: <>AMD Ryzen 7 <span className="text-rose-500">3800XT 8-Core</span></>,
    ...
    bgDark: 'from-slate-900 via-rose-950/30 to-slate-950',
    bgLight: 'from-rose-50 via-pink-100/60 to-slate-50',
  ...
  },
  {
    ...
    title: <>ASUS Marshmallow <span className="text-blue-500">Silent Multi-Mode</span></>,
    ...
    bgDark: 'from-slate-900 via-blue-950/35 to-slate-950',
    bgLight: 'from-blue-50 via-sky-100/60 to-slate-50',
    glow1: 'bg-blue-600/20',
    glow2: 'bg-cyan-500/15'
  },
  {
    ...
    bgDark: 'from-slate-900 via-pink-950/35 to-slate-950',
    bgLight: 'from-pink-50 via-rose-100/60 to-slate-50',
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[var(--bg-page)] transition-colors duration-300">
      ...
      <section className="relative min-h-[55vh] sm:min-h-[90vh] flex items-center overflow-hidden pt-4 sm:pt-16 bg-[var(--bg-page-alt)] border-b border-[var(--border-color)]">
        {SLIDES.map((slide, index) => {
          ...
          return (
            ...
            >
              ...
              <div className={`absolute inset-0 bg-gradient-to-br dark:${slide.bgDark} ${slide.bgLight}`} />
              ...
              <div className="relative z-20 w-full max-w-7xl mx-auto px-3 sm:px-6 lg:px-12 grid grid-cols-2 lg:grid-cols-12 gap-3 lg:gap-10 items-center pt-20 sm:pt-32 lg:pt-16">
                ...
                <div className="col-span-1 lg:col-span-7 text-left order-1 lg:order-1">
                  ...
                  <h1 className={`text-sm sm:text-4xl lg:text-5xl xl:text-6xl font-heading font-bold text-[var(--text-primary)] mb-2 leading-tight transition-all duration-700 delay-500 transform
                    ${isActive ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
                    {slide.title}
                  </h1>
                  
                  <p className={`text-[9px] sm:text-lg text-[var(--text-muted)] mb-4 leading-snug transition-all duration-700 delay-700 transform
                    ${isActive ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
                ...
                {/* RIGHT COLUMN: Floating product canvas */}
                <div className="col-span-1 lg:col-span-5 flex justify-center lg:justify-end items-center order-2 lg:order-2">
                  <div className={`relative w-32 h-32 sm:w-72 sm:h-72 lg:w-[440px] lg:h-[440px] rounded-xl lg:rounded-[2rem] overflow-hidden border border-[var(--border-color)] shadow-2xl bg-[var(--bg-surface)]/80 backdrop-blur-md transition-all duration-1000 cubic-bezier(0.16, 1, 0.3, 1) delay-500 transform
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-[var(--bg-page-alt)]/40 to-transparent pointer-events-none" />
                  </div>
                </div>
          ...
          {SLIDES.map((_, idx) => (
            <button
              ...
              className={`w-2.5 h-2.5 rounded-full transition-all duration-500 cursor-pointer
                ${idx === currentSlide ? 'w-8 bg-primary-500 shadow-glow' : 'bg-[var(--text-subtle)]/40 hover:bg-[var(--text-muted)]'}`}
              title={`Slide ${idx + 1}`}
            />
          ))}
        </div>

        {/* Lateral Arrow Navigation */}
        <button
          onClick={() => setCurrentSlide(prev => (prev - 1 + SLIDES.length) % SLIDES.length)}
          className="absolute left-6 top-1/2 -translate-y-1/2 z-30 hidden lg:flex w-12 h-12 items-center justify-center bg-[var(--bg-surface)]/70 backdrop-blur-md border border-[var(--border-color)] text-[var(--text-primary)] rounded-full hover:bg-primary-600 hover:text-white transition-all hover:scale-110 cursor-pointer active:scale-95 shadow-md"
        ...
        <button
          ...
          className="absolute right-6 top-1/2 -translate-y-1/2 z-30 hidden lg:flex w-12 h-12 items-center justify-center bg-[var(--bg-surface)]/70 backdrop-blur-md border border-[var(--border-color)] text-[var(--text-primary)] rounded-full hover:bg-primary-600 hover:text-white transition-all hover:scale-110 cursor-pointer active:scale-95 shadow-md"
          title="Next Slide"
        >
      ...
      <section className="section py-8 sm:py-16">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
          {[
            ...
            <div key={i} className="flex flex-col items-center text-center p-3 sm:p-5 rounded-2xl bg-[var(--bg-surface)] border border-[var(--border-color)] hover:border-primary-500/40 transition-all group max-w-[150px] sm:max-w-none mx-auto w-full shadow-sm">
              <div className="w-8 h-8 sm:w-12 sm:h-12 rounded-lg sm:rounded-xl bg-primary-500/10 flex items-center justify-center mb-3 sm:mb-4 group-hover:scale-110 transition-transform">
                <feature.icon className="w-4 h-4 sm:w-6 sm:h-6 text-primary-500" />
              </div>
              <h3 className="text-[10px] sm:text-lg font-bold text-[var(--text-primary)] mb-1">{feature.title}</h3>
              <p className="text-[8px] sm:text-sm text-[var(--text-muted)]">{feature.desc}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      {/* Categories */}
      {categories.length > 0 && (
        <section className="section bg-[var(--bg-page-alt)] relative overflow-hidden rounded-3xl my-8 border border-[var(--border-color)]">
          <div className="relative z-10">
            <div className="text-center mb-8 sm:mb-12">
              <h2 className="text-lg sm:text-4xl font-bold text-[var(--text-primary)] mb-2 sm:mb-4">Shop by Category</h2>
              <p className="text-[10px] sm:text-lg text-[var(--text-muted)]">High-performance technology tailored for you</p>
            </div>
                ...
                .map((cat) => {
                  ...
                  return (
                    <Link 
                      ...
                      className="glass-card p-2 sm:p-4 text-center hover:-translate-y-1.5 border border-[var(--border-color)] hover:border-primary-500/40 transition-all duration-300 cursor-pointer group flex flex-col items-center relative overflow-hidden max-w-[110px] sm:max-w-none mx-auto w-full shadow-sm"
                    >
                      <div className="w-14 h-14 sm:w-16 sm:h-16 bg-[var(--bg-surface-hover)] rounded-2xl flex items-center justify-center mb-2 sm:mb-3 border border-[var(--border-color)] shadow-inner group-hover:border-primary-500/40 transition-all duration-300 overflow-hidden p-2 sm:p-3 relative">
                        {catImgUrl ? (
                          <img 
                            src={catImgUrl} 
                            alt={cat.name} 
                            className="w-full h-full object-contain transition-transform duration-500 group-hover:scale-110 z-10"
                          />
                        ) : (
                      ...
                      <h3 className="font-semibold text-[var(--text-primary)] text-[10px] sm:text-base relative z-10">{cat.name}</h3>
                    </Link>
                  );
                })}
            </div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="relative rounded-2xl overflow-hidden bg-gradient-to-r from-primary-700 via-primary-800 to-cyan-800 shadow-xl p-8 sm:p-12 text-center text-white">
            <div className="relative z-10">
              <h2 className="text-2xl sm:text-4xl font-heading font-bold mb-4">Get 20% Off Your First Order</h2>
              <p className="text-blue-100 mb-6">Use code <span className="font-mono font-bold text-white bg-black/20 px-3 py-1 rounded-lg border border-white/20">WELCOME20</span> at checkout</p>
              <Link to="/products" className="btn-primary btn-lg bg-white text-primary-700 hover:bg-slate-100">Shop Now</Link>
            </div>
          </div>
        </div>
      </section>
